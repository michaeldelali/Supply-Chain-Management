...
contract OrderRegistry {
  ...
  function createOrder(string memory orderno, string memory product, string memory temp,
   string memory value, string memory quantity, string memory delivery) public {
  ...
  function setMfgValues(string memory orderno, string memory name, string memory material,
  string memory delivery, string memory value, string memory quantity) public {
  ...
  function fetchInitialDetails(string memory orderno) public view returns(string memory, string memory, string memory,
